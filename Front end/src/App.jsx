...
function App() {
  ...
  useEffect(() => {
    fetch("https://financetrackerdeploy.onrender.com/transactions")
      .then((res) => res.json())
      .then((data) => {
  ...
  const addTransaction = async (tx) => {
    try {
      const res = await fetch("https://financetrackerdeploy.onrender.com/transactions", {
        method: "POST",
  ...
  const deleteTransaction = async (_id) => {
    try {
      await fetch(`https://financetrackerdeploy.onrender.com/transactions/${_id}`, {
        method: "DELETE",
      });
